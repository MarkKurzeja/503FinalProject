...
\author{\spacedlowsmallcaps{Andrei Kopelevich $\bullet$ Mark Kurzeja $\bullet$ Eli Shultz }}
\date{} % no date or \today if you want to insert a date

\maketitle

\begin{abstract}
	March Madness Predictions are one of the few examples of a nationwide form of prediction competition that happens every year during the conclusion of the NCAA Men's Basketball season. Despite the relatively simple nature of the sport of basketball itself, the tournament is notoriously difficult to predict, and to have a ``perfect bracket'' is improbable that Warren Buffet, a US investor, has famously put a standing bet of \$1MM a year for life if someone can predict a perfect bracket. Most algorithms for predicting the tournament typically attempt to predict the results at the game level. We instead change our focus to predicting how many rounds we expect a team to progress in the tournament, which will allow us to build far more stable predictions and hopefully improve on the odds that we can predict the final state of tournament play for a given year.
\end{abstract}
...
%                                                                              %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{NCAA Tournament Background}
\lipsum
...
%                                                                              %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{The March Madness Prediction Problem}
\lipsum
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                              %
%                              Prelim Discussion                               %
