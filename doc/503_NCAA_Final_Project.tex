...
\definecolor{harvard}{HTML}{c90016}
...
\begin{center}
	\large \color{harvard} \spacedlowsmallcaps{April 16$^{th}$, 2018 \hspace{1mm} $\vert$ \hspace{1mm} Professor Long}
\end{center}
...
%\end{figure}
\missingfigure{Andrei, you didn't upload clusterfun :( Its erring out on my machine }
...
Next we examine if we can see similar distinctions under hierarchical clustering.
